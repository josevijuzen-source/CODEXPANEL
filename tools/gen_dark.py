#!/usr/bin/env python3
"""Generate a dark-mode override stylesheet for CodexPanel internal pages.
...
ROOT = "/Users/cyberpersons/codexpanel"
...
def border_token(val):
    # value may be "1px solid #e8e9ff" â€” extract color
    n = norm(val)
...
out = []
out.append("/* ====================================================================")
out.append("   CodexPanel Dark-Mode Overrides  (AUTO-GENERATED â€” issue #1804)")
out.append("   --------------------------------------------------------------------")
...
out.append("   brand / semantic colors (accents, success, dangerâ€¦) are left untouched.")
out.append("   Regenerate with tools/gen_dark.py â€” do not edit by hand.")
out.append("   ==================================================================== */")
out.append("")
...
dest = os.path.join(ROOT, "baseTemplate/static/baseTemplate/css/codexpanel-dark.css")
open(dest, "w").write("\n".join(out) + "\n")
