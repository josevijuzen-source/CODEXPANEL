#!/usr/bin/env python3
"""Define the design tokens that CodexPanel templates REFERENCE but that were
...
collects those tokens and emits codexpanel-tokens.css with:
...
for c in glob.glob(os.path.join(ROOT, "baseTemplate/static/baseTemplate/css/*.css")):
    if c.endswith("codexpanel-tokens.css"):
        continue
...
out = []
out.append("/* ====================================================================")
out.append("   CodexPanel Missing Design Tokens  (AUTO-GENERATED â€” issue #1804)")
out.append("   --------------------------------------------------------------------")
...
out.append("   Regenerate with tools/gen_tokens.py â€” do not edit by hand.")
out.append("   ==================================================================== */")
out.append(":root {")
...
dest = os.path.join(ROOT, "baseTemplate/static/baseTemplate/css/codexpanel-tokens.css")
open(dest, "w").write("\n".join(out) + "\n")
