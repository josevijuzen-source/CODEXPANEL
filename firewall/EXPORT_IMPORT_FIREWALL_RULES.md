...
This feature allows CodexPanel administrators to export and import firewall rules between servers, making it easy to replicate security configurations across multiple servers.

## Features

### Export Functionality
- Exports all custom firewall rules to a JSON file
- Excludes default CodexPanel rules (CodexPanel Admin, SSHCustom) to prevent conflicts
...
- Excludes default CodexPanel rules from import
...
### Exporting Rules
1. Navigate to the Firewall section in CodexPanel
...
- Default CodexPanel rules are excluded to prevent system conflicts
...
- Compatible with CodexPanel's existing firewall system
