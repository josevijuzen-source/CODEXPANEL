# Contributing to CodexPanel

Thank you for your interest in contributing to CodexPanel! This document provides guidelines and information for contributors.

## ðŸŒ¿ Branch Structure

CodexPanel uses a structured branching strategy to manage development and releases:
...
- âŒ **DON'T**: Create pull requests for any other branches (stable, old dev branches, etc.)
- ðŸ”„ **Development**: All development happens only in the latest dev branch
- ðŸ—‘ï¸ **Cleanup**: Old dev branches are deleted after merging to stable
...
1. **Fork the Repository**
   ...
   git clone https://github.com/YOUR_USERNAME/CodexPanel.git
   cd CodexPanel
   ```

2. **Add Upstream Remote**
   ```bash
   git remote add upstream https://github.com/usmannasir/CodexPanel.git
   ```
...
- **OS and Version**: Your operating system and CodexPanel version
...
- Email security concerns to: security@codexpanel.net
...
CodexPanel follows semantic versioning (MAJOR.MINOR.PATCH):
...
- ðŸ“š [Documentation](https://codexpanel.net/KnowledgeBase/)
...
By contributing to CodexPanel, you agree that your contributions will be licensed under the same license as the project (GPL-3.0).

---

**Thank you for contributing to CodexPanel!** ðŸŽ‰
