    ...
    def check_and_run_scans(self):
        ...
        for scan in all_scans:
            ...
            if scan.status != 'active':
                ...
                self.stdout.write(f'  âŒ {reason}')
            ...
            if scan.next_run is None:
                ...
                if self.verbose:
                    ...
                    try:
                        ...
                        self.stdout.write(f'  âŒ Failed to calculate next run: {str(e)}')
                continue
            ...
            for domain in domains_to_scan:
                try:
                    ...
                    class FakeRequest:
                        ...
                        def get_host(self):
                            # Get the hostname from CodexPanel settings
                            try:
                                from plogical.acl import ACLManager
                                server_ip = ACLManager.fetchIP()
                                return f"{server_ip}:8090"  # Default CodexPanel port
                            except:
...
View detailed results in your CodexPanel AI Scanner dashboard.
"""
            
            # Send email using codexpanel's email system
            from plogical.mailUtilities import mailUtilities
            sender = 'noreply@codexpanel.local'
...
Please check your CodexPanel AI Scanner configuration and try again.
"""
