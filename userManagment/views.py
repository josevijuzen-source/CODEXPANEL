...
from CodexCP.secMiddleware import secMiddleware
from CodexCP.SecurityLevel import SecurityLevel
...
def submitUserCreation(request):
    try:
        ...
        try:
            ...
            if ACLManager.CheckRegEx("^[\w'\-,.][^0-9_!Â¡?Ã·?Â¿/\\+=@#$%Ë†&*(){}|~<>;:[\]]{2,}$", firstName) == 0:
            ...
            if ACLManager.CheckRegEx("^[\w'\-,.][^0-9_!Â¡?Ã·?Â¿/\\+=@#$%Ë†&*(){}|~<>;:[\]]{2,}$", lastName) == 0:
    ...
    try:
        ...
        try:
            if request.method == 'POST':
                ...
                otpauth = pyotp.totp.TOTP(user.secretKey).provisioning_uri(email, issuer_name="CodexPanel")
