...
def main():
    ...
    try:
        ...
        elif os.path.isfile('/usr/bin/codexpanel') | os.path.isfile(os.getcwd() + '/codexpanel'):
    ...
    if username == 'root' and controlpanel == 'codexpanel':
        # Needs updated to glob all /home/*/logs/
        path = '/home/*/logs/*'
        domlogs_path = glob.glob("/home/*/logs/")
        print('Root CodexPanel Detected')
    ...
    if controlpanel == 'Cpanel' or controlpanel == 'codexpanel':
