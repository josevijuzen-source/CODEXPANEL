...
class TestFTP(TestCase):
    ...
    def test_submitFTPCreation(self):
        ...
        data_ret = {'ftpDomain': 'codexpanel.xyz', 'ftpUserName':'hello', 'passwordByPass':'helloworld'}
        ...
        self.assertEqual(os.path.exists('/home/codexpanel.xyz/unittest'), True)
