...
class TestMailServer(TestCase):
    ...
    def MakeRequest(self, endPoint, data):
        ...
        path = 'https://codexpanel.xyz:8090/%s' % (endPoint)
    ...
    def setUp(self):
        ...
        data_ret = {'virtualHost': 'codexpanel.xyz'}
    ...
    def test_submitEmailCreation(self):
        ...
        data_ret = {'domain': 'codexpanel.xyz', 'username':'helloworld', 'passwordByPass':'helloworld'}
        ...
        try:
            ok = 1
            smtpServer = smtplib.SMTP('codexpanel.xyz', 25)
            smtpServer.login('helloworld@codexpanel.xyz', 'helloworld')

            message = MIMEMultipart('alternative')
            message['Subject'] = 'Test Email'
            message['From'] = 'Unit Test' + ' ' + 'helloworld@codexpanel.xyz'
            message['reply-to'] = 'helloworld@codexpanel.xyz'
        ...
        data_ret = {'email': 'helloworld@codexpanel.xyz'}
