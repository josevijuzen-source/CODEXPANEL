...
class installUtilities:
    ...
    def enableEPELRepo():
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [enableEPELRepo]")
            return 0
    ...
    def addLiteSpeedRepo():
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [addLiteSpeedRepo]")
            return 0
        except ValueError as msg:
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [addLiteSpeedRepo]")
            return 0
    ...
    def installLiteSpeed():
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [installLiteSpeed]")
            return 0
        except ValueError as msg:
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [installLiteSpeed]")
            return 0
    ...
    def startLiteSpeed():
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [startLiteSpeed]")
            return 0
        except ValueError as msg:
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [startLiteSpeed]")
            return 0
    ...
    def reStartLiteSpeed():
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [reStartLiteSpeed]")
            return 0
    ...
    def reStartOpenLiteSpeed(restart,orestart):
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [reStartOpenLiteSpeed]")
            return 0
        except ValueError as msg:
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [reStartOpenLiteSpeed]")
            return 0
    ...
    def changePortTo80():
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [changePortTo80]")
            return 0
    ...
    def installAllPHPVersion():
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [installAllPHPVersion]")
    ...
    def installAllPHPToLitespeed():
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [installAllPHPToLitespeed]")
            return 0
    ...
    def removeWebServer():
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [removeWebServer]")
            return 0
        except ValueError as msg:
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [removeWebServer]")
            return 0
    ...
    def startMariaDB():
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [startMariaDB]")
            return 0
        except ValueError as msg:
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [startMariaDB]")
            return 0
    ...
    def installMySQL(password):
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [installMySQL]")
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " Could not add mariadb to startup [installMySQL]")
            return 0
        except ValueError as msg:
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " Could not add mariadb to startup [installMySQL]")
            return 0
    ...
    def secureMysqlInstallation(password):
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " Exception EOF [installMySQL]")
            print("###########################Before########################################")
