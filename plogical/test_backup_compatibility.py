...
class BackupCompatibilityTests:
    ...
    def setup_test_environment():
        ...
        test_dir = tempfile.mkdtemp(prefix="codexpanel_backup_test_")
        ...
        try:
            ...
            if result == 1:
                ...
                if os.path.exists(legacy_file):
                    ...
                    print(f"âœ— Legacy backup file not found: {legacy_file}")
                    return False
            else:
                print(f"âœ— Legacy backup failed")
                return False

        except Exception as e:
            print(f"âœ— Error during legacy backup test: {str(e)}")
            return False
    ...
    def test_new_backup(test_db="test_new_db", test_dir="/tmp"):
        ...
        try:
            ...
            if result == 1:
                print(f"âœ“ New backup created successfully")

                # Check that .sql.gz file exists
                compressed_file = f"{test_dir}/{test_db}.sql.gz"
                if os.path.exists(compressed_file):
                    file_size = os.path.getsize(compressed_file)
                    print(f"âœ“ Compressed backup file exists: {compressed_file}")
                    print(f"  File size: {file_size} bytes")
                    ...
                    print(f"âœ— Compressed backup file not found: {compressed_file}")
                ...
                print(f"âœ— New backup failed")
                return False

        except Exception as e:
            print(f"âœ— Error during new backup test: {str(e)}")
            return False
    ...
    def run_all_tests():
        ...
        print("=" * 60)
        print("codexpanel Database Backup Compatibility Test Suite")
        print("=" * 60)
