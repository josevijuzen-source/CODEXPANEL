...
class modSec:
    ...
    MODSEC_COMPATIBLE = {
        'rhel8': {
            'url': 'https://codexpanel.net/mod_security-2.4.4-x86_64-rhel8.so',
            'sha256': 'bbbf003bdc7979b98f09b640dffe2cbbe5f855427f41319e4c121403c05837b2'
        },
        'rhel9': {
            'url': 'https://codexpanel.net/mod_security-2.4.4-x86_64-rhel9.so',
            'sha256': '19deb2ffbaf1334cf4ce4d46d53f747a75b29e835bf5a01f91ebcc0c78e98629'
        },
        'ubuntu': {
            'url': 'https://codexpanel.net/mod_security-2.4.4-x86_64-ubuntu.so',
    ...
    def downloadCompatibleModSec(platform):
        ...
        try:
            ...
            if not config:
                logging.CodexCPLogFileWriter.writeToFile(f"No compatible ModSecurity for platform {platform}")
                return False
            ...
            if result != 0:
                logging.CodexCPLogFileWriter.writeToFile("Failed to download compatible ModSecurity")
                return False
            ...
            if actual_sha256 != config['sha256']:
                logging.CodexCPLogFileWriter.writeToFile(f"ModSecurity checksum mismatch: expected {config['sha256']}, got {actual_sha256}")
                os.remove(tmp_path)
                return False
            ...
            logging.CodexCPLogFileWriter.writeToFile("Installed compatible ModSecurity binary")
            return True

        except BaseException as msg:
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [downloadCompatibleModSec]")
            return False
    ...
    def isCustomOLSBinaryInstalled():
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(f"WARNING: Could not detect OLS binary type: {msg}")
            return False
    ...
    def detectBinarySuffix():
        ...
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(f"Error detecting OS: {msg}, defaulting to Ubuntu binaries")
            return 'ubuntu'
    ...
    def installCompatibleModSecurity():
        ...
        try:
            ...
            BASE_URL = "https://codexpanel.net/binaries"
            ...
            if result != 0 or not os.path.exists(tmp_modsec):
                ...
                logging.CodexCPLogFileWriter.writeToFile("[Could not download compatible ModSecurity]")
                return 0
            ...
            if actual_sha256 != EXPECTED_SHA256:
                ...
                logging.CodexCPLogFileWriter.writeToFile("[ModSecurity checksum verification failed]")
                return 0
            ...
            logging.CodexCPLogFileWriter.writeToFile("[Compatible ModSecurity installed successfully]")
            return 1
            ...
            with open(modSec.installLogPath, 'a') as f:
                ...
                f.write("Can not be installed.[404]\n")
            logging.CodexCPLogFileWriter.writeToFile("[Timeout during ModSecurity installation]")
            return 0
        except Exception as msg:
            with open(modSec.installLogPath, 'a') as f:
                f.write(f"ERROR: {str(msg)}\n")
                f.write("Can not be installed.[404]\n")
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + "[installCompatibleModSecurity]")
            return 0
    ...
    def installModSec():
        try:
            ...
            if res == 1:
                ...
                writeToFile.close()
                logging.CodexCPLogFileWriter.writeToFile("[Could not Install]")
                return 0
            else:
                writeToFile = open(modSec.installLogPath, 'a')
            ...
            custom_ols_marker = "/usr/local/lsws/modules/codexpanel_ols.so"
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + "[installModSec]")
...
"""
        ...
        try:
            ...
            if ProcessUtilities.decideServer() == ProcessUtilities.OLS:
                ...
                try:
                    ...
                    logging.CodexCPLogFileWriter.writeToFile(str(msg) + ' [disableComodo]')
    ...
    def setupOWASPRules():
        try:
            ...
            result = subprocess.call(shlex.split(command))
            if result != 0:
                logging.CodexCPLogFileWriter.writeToFile("Failed to create modsec directory [setupOWASPRules]")
                return 0
            ...
            if result != 0:
                logging.CodexCPLogFileWriter.writeToFile("Failed to download OWASP CRS from GitHub. Check internet connection. [setupOWASPRules]")
                return 0
            ...
            if result != 0:
                logging.CodexCPLogFileWriter.writeToFile("Failed to extract OWASP CRS zip file. Ensure unzip is installed. [setupOWASPRules]")
                return 0
            ...
            if result != 0:
                logging.CodexCPLogFileWriter.writeToFile("Failed to rename OWASP CRS directory. File may already exist. [setupOWASPRules]")
                return 0
            ...
            if result != 0:
                logging.CodexCPLogFileWriter.writeToFile("Failed to setup crs-setup.conf configuration file. [setupOWASPRules]")
                return 0
            ...
            if result != 0:
                logging.CodexCPLogFileWriter.writeToFile("Failed to setup REQUEST-900 exclusion rules. [setupOWASPRules]")
                return 0
            ...
            if result != 0:
                logging.CodexCPLogFileWriter.writeToFile("Failed to setup RESPONSE-999 exclusion rules. [setupOWASPRules]")
                return 0
