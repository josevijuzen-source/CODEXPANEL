...
TERMINAL_JWT_SECRET_ENV = "codexpanel_TERMINAL_JWT_SECRET"
TERMINAL_JWT_SECRET_FILE_ENV = "codexpanel_TERMINAL_JWT_SECRET_FILE"
DEFAULT_TERMINAL_JWT_SECRET_FILE = "/usr/local/CodexCP/terminal_jwt_secret"
