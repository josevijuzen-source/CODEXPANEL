...
class DNS:
    ...
    CFPath = '/home/codexpanel/CloudFlare'
    ...
    def loadCFKeys(self):
        ...
        if os.path.exists(cfFile):
            ...
            #logging.CodexCPLogFileWriter.writeToFile('User %s does not have CloudFlare configured.' % (self.admin.userName))
            return 0
    ...
    def createDNSRecordCloudFlare(cf, zone, name, type, value, priority, ttl):
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + '. [createDNSRecordCloudFlare]')
    ...
    def createDNSRecord(zone, name, type, value, priority, ttl):
        try:
            ...
            logging.CodexCPLogFileWriter.writeToFile(str(msg) + " [createDNSRecord]")
...
"""
            ...
            logging.CodexCPLogFileWriter.writeToFile(f'ConfigurePowerDNSInAcme, Error: {str(msg)}')
            return 0, str(msg)
...
"""
            ...
            logging.CodexCPLogFileWriter.writeToFile(f'ConfigureCloudflareInAcme, Error: {str(msg)}')
            return 0, str(msg)
