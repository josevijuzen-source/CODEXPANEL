...
for CodexPanel AI Scanner file operations.
"""
...
def main():
    """Main test function"""
    print("codexpanel AI Scanner Authentication Test")
    print("="*50)
    ...
    if len(sys.argv) > 1:
        ...
        print("\n" + "="*50)
        print("Test Results:")
        print(f"  Bearer authentication: {'âœ“ PASS' if bearer_success else 'âœ— FAIL'}")
        print(f"  X-API-Key authentication: {'âœ“ PASS' if api_key_success else 'âœ— FAIL'}")
        print("="*50)
    else:
