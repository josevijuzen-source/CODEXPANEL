...
# .htaccess module, binary integrity, CodexPanel module
# ============================================================
echo ""
echo "============================================================"
...
# ============================================================
echo "=== TEST GROUP 19: CodexPanel Module ==="
# ============================================================
if [ -f /usr/local/lsws/modules/codexpanel_ols.so ]; then
    pass "T19.1: codexpanel_ols.so module exists"
else
    fail "T19.1: codexpanel_ols.so module missing"
fi

if grep -q "module codexpanel_ols" /usr/local/lsws/conf/httpd_config.conf; then
...
if [ "$WORD_COUNT" -eq 2 ]; then
    ...
    fail "T20.3: acmeEmail line has $WORD_COUNT fields (expected 2) â€” possible config injection bug"
fi
