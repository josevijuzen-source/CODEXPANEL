"""
Django settings for CodexCP project.
...
if not SECRET_KEY:
    _secret_key_path = os.getenv('codexpanel_SECRET_KEY_FILE', '/usr/local/CodexCP/secret_key')
    try:
...
MIDDLEWARE = [
    ...
    'CodexCP.secMiddleware.secMiddleware'
]

ROOT_URLCONF = 'CodexCP.urls'
...
WSGI_APPLICATION = 'CodexCP.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'codexpanel'),
        'USER': os.getenv('DB_USER', 'codexpanel'),
...
MEDIA_URL = '/usr/local/CodexCP/tmp/'
