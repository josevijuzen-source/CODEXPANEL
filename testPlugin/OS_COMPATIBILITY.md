# OS Compatibility Guide - CodexPanel Test Plugin

## ðŸŒ Supported Operating Systems

The CodexPanel Test Plugin is designed to work seamlessly across all CodexPanel-supported operating systems with comprehensive multi-OS compatibility.
...
# Web Server: apache2
# User/Group: CodexPanel:CodexPanel
```
...
|----------------|--------------|--------------|-------------|-------------|--------------|--------------|-------|-------|--------------|
| **3.6** | âŒ | âŒ | âŒ | âœ… | âŒ | âœ… | âŒ | âœ… | âœ… |
| **3.7** | âŒ | âŒ | âŒ | âœ… | âŒ | âœ… | âŒ | âœ… | âœ… |
| **3.8** | âŒ | âœ… | âŒ | âœ… | âŒ | âœ… | âŒ | âœ… | âœ… |
| **3.9** | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… |
| **3.10** | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… |
| **3.11** | âœ… | âŒ | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… |
| **3.12** | âœ… | âŒ | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… | âœ… |
...
chcon -R -t httpd_exec_t /usr/local/CodexCP/testPlugin/
```
...
cd /usr/local/CodexCP/testPlugin
...
- âœ… CodexPanel integration

### Sample Output
```
ðŸ” Testing OS Compatibility for CodexPanel Test Plugin
============================================================
...
ðŸ” Testing File Permissions...
   âœ… Plugin Directory: /home/codexpanel/plugins
   âœ… CodexPanel Directory: /usr/local/CodexCP

ðŸŒ Testing Network Connectivity...
   âœ… GitHub: True
   âœ… Internet: True

âš¡ Testing CodexPanel Integration...
   âœ… CodexPanel Installed: True
...
# Permission denied
sudo chown -R CodexPanel:CodexPanel /home/codexpanel/plugins
sudo chown -R CodexPanel:CodexPanel /usr/local/CodexCP/testPlugin
...
sudo chcon -R -t httpd_exec_t /usr/local/CodexCP/testPlugin/
...
ls -la /home/codexpanel/plugins/
ls -la /usr/local/CodexCP/testPlugin/

# Check CodexPanel logs
tail -f /home/codexpanel/logs/CodexPanel.log
tail -f /home/codexpanel/logs/django.log
```
...
- [ ] Ensure CodexPanel is installed and running
...
# Or manually remove
sudo rm -rf /usr/local/CodexCP/testPlugin
sudo rm -f /home/codexpanel/plugins/testPlugin
```
...
### Plugin Support
- **GitHub Issues**: https://github.com/CodexPanel/testPlugin/issues
- **CodexPanel Forums**: https://forums.CodexPanel.net/
- **Documentation**: https://codexpanel.net/docs/
