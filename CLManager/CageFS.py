...
class CageFS:
    ...
    def submitinstallImunify(key):
        try:
            ...
            imunifyKeyPath = '/home/codexpanel/imunifyKeyPath'
            ...
            content = """[paths]
ui_path =/usr/local/CodexCP/public/imunify
[web_server]
...
"""
            ...
            command = 'mkdir /usr/local/CodexCP/public/imunify'
    ...
    def submitinstallImunifyAV():
        try:
            ...
            content = """[paths]
ui_path = /usr/local/CodexCP/public/imunifyav
...
"""
            ...
            command = 'mkdir -p /usr/local/CodexCP/public/imunifyav'
            ServerStatusUtil.executioner(command, statusFile)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='CodexPanel CageFS Manager')
