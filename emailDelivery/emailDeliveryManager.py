...
class EmailDeliveryManager:
    ...
    def connect(self, request, userID):
        try:
            ...
            # Public endpoint â€” no API key needed for registration
    ...
    def disableRelay(self, request, userID):
        try:
            ...
            execPath = "/usr/local/CodexCP/bin/python /usr/local/CodexCP/plogical/mailUtilities.py removeRelayHost"
            output = ProcessUtilities.outputExecutioner(execPath)
