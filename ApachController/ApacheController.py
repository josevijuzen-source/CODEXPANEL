...
class ApacheController:
    apacheInstallStatusPath = '/home/codexpanel/apacheInstallStatus'
...
<IfModule mpm_event_module>
    ...
    def setupApache(statusFile):
        try:
            ...
            logging.CodexCPLogFileWriter.statusWriter(statusFile, 'Starting Apache installation. It may take some time..,70')
            ...
            logging.CodexCPLogFileWriter.statusWriter(statusFile,
