...
def router(request):
    try:
        ...
        if controller == 'verifyLogin':
        ...
        elif controller == 'SubmitCodexPanelUpgrade':
            return cm.SubmitCodexPanelUpgrade()
            ...
            return cm.ajaxPre(0, 'This function is not available in your version of codexpanel.')
