...
class ServiceManager:
    ...
    slaveConfPath = '/home/codexpanel/slaveConf'
...
'''
        ...
        command = 'touch /home/codexpanel/elasticsearch'
        ServerStatusUtil.executioner(command, statusFile)
    ...
    def RemoveElasticSearch():
        ...
        command = 'rm -f /home/codexpanel/elasticsearch'
        ServerStatusUtil.executioner(command, statusFile)
    ...
    def InstallRedis():
        ...
        command = 'touch /home/codexpanel/redis'
        ServerStatusUtil.executioner(command, statusFile)
    ...
    def RemoveRedis():
        ...
        command = 'rm -f /home/codexpanel/redis'
        ServerStatusUtil.executioner(command, statusFile)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='CodexPanel Application Manager')
