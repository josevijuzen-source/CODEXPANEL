...
def manageApplications(request):
    ...
    esPath = '/home/codexpanel/elasticsearch'
    rPath = '/home/codexpanel/redis'
        ...
        try:
            ...
            if appName == 'Elasticsearch':
                if status == 'Installing':
                    command = '/usr/local/CodexCP/bin/python /usr/local/CodexCP/manageServices/serviceManager.py --function InstallElasticSearch'
                else:
                    command = '/usr/local/CodexCP/bin/python /usr/local/CodexCP/manageServices/serviceManager.py --function RemoveElasticSearch'
            elif appName == 'Redis':
                if status == 'Installing':
                    command = '/usr/local/CodexCP/bin/python /usr/local/CodexCP/manageServices/serviceManager.py --function InstallRedis'
                else:
                    command = '/usr/local/CodexCP/bin/python /usr/local/CodexCP/manageServices/serviceManager.py --function RemoveRedis'
