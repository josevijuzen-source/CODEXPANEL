# Debian 13 Installation Guide for CodexPanel

## ðŸŽ¯ Overview

This guide provides step-by-step instructions for installing CodexPanel on Debian 13 (Bookworm). Debian 13 support has been added to CodexPanel with full compatibility for package management, service configuration, and web server setup.
...
- âœ… **Debian 13** (Bookworm) - Full Support
- âœ… **Debian 12** (Bookworm) - Full Support  
- âœ… **Debian 11** (Bullseye) - Full Support
...
### Step 2: Download and Run CodexPanel Installer

```bash
# Download the latest CodexPanel installer
wget https://codexpanel.sh/install.sh
...
```bash
# Check CodexPanel service status
sudo systemctl status lscpd

# Check web server status
sudo systemctl status apache2

# Check if CodexPanel is accessible
...
```bash
# Login to CodexPanel CLI
sudo CodexPanel

# Change admin password
CodexPanel --change-password admin
```

### Configure Firewall

```bash
# Allow CodexPanel ports
...
**Problem**: CodexPanel service fails to start
...
- **CodexPanel**: `/usr/local/CodexCP/logs/`
- **Apache2**: `/var/log/apache2/`
- **System**: `/var/log/syslog`
- **Installation**: `/root/CodexPanel-install.log`
...
1. **Change Default Password**
   ```bash
   sudo CodexPanel --change-password admin
   ```
...
1. **Access CodexPanel Web Interface**
2. **Navigate to**: SSL â†’ Let's Encrypt
...
1. **Access CodexPanel Web Interface**
2. **Navigate to**: PHP â†’ PHP Settings
3. **Configure**:
   - Memory limit: 256M
...
sudo CodexPanel --update

# Or use the upgrade script
sudo ./codexpanel_upgrade.sh
```
...
### Documentation
- [CodexPanel Official Docs](https://codexpanel.net/docs/)
...
### Community Support
- [CodexPanel Community Forum](https://forums.CodexPanel.net/)
- [GitHub Issues](https://github.com/usmannasir/CodexPanel/issues)
- [Discord Server](https://discord.gg/CodexPanel)
...
wget https://raw.githubusercontent.com/CodexPanel/CodexPanel/main/test_debian13_support.sh
...
- [ ] CodexPanel web interface accessible
...
**Note**: This guide is specifically for Debian 13. For other operating systems, refer to the main CodexPanel documentation.
