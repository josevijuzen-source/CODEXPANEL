# CodexPanel OpenLiteSpeed Module - Complete Usage Guide
...
12. [CodexPanel Integration](#CodexPanel-integration)
...
The CodexPanel OpenLiteSpeed Module brings Apache .htaccess compatibility to OpenLiteSpeed servers. It allows you to use familiar Apache directives without switching web servers.

### Quick Start

1. **Module is pre-installed** on CodexPanel servers
...
### CodexPanel Integration

#### Via File Manager

1. Log into **CodexPanel**
...
1. Create subdomain `staging.yourdomain.com` in CodexPanel
...
#### Protect CodexPanel Access

```apache
# In /usr/local/CodexCP/public/.htaccess (if web accessible)
Order deny,allow
Deny from all
...
**Solution:**
1. Verify module loaded: `ls -la /usr/local/lsws/modules/codexpanel_ols.so`
...
**Steps:**
1. Keep old domain active in CodexPanel
...
- CodexPanel uses LSPHP by default âœ…
...
```bash
# Check module loaded
ls -la /usr/local/lsws/modules/codexpanel_ols.so
...
#### Via CodexPanel File Manager

1. Log into **CodexPanel** (https://yourserver:8090)
...
1. **Create Website** in CodexPanel
...
grep CodexPanel_ols /usr/local/lsws/conf/httpd_config.conf
# Should show: module CodexPanel_ols {
...
# CodexPanel uses LSPHP by default
...
grep "CodexPanel_access" /usr/local/lsws/logs/error.log
...
```bash
# Module version
ls -lh /usr/local/lsws/modules/codexpanel_ols.so
...
- **GitHub:** [github.com/usmannasir/codexpanel_ols](https://github.com/usmannasir/codexpanel_ols)
- **Community:** [community.CodexPanel.net](https://community.codexpanel.net)
...
*Thank you for using the CodexPanel OpenLiteSpeed Module!*
