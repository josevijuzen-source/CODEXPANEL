...
class SMTPClient:
    ...
    Supports two modes:
    1. Authenticated (port 587 + STARTTLS) â€” for standalone login sessions
    2. Local relay (port 25, no auth) â€” for SSO sessions using master user
    ...
    def save_to_sent(self, imap_client, raw_message):
        ...
        codexpanel's Dovecot uses INBOX.Sent as the Sent folder.
        """
        # Try codexpanel's actual folder name first, then fallbacks
