...
${PURPLE}1.${NC} How to reset CodexPanel admin password?
...
Please check this post: ${GREEN}https://community.codexpanel.net/c/support/55${NC}

${BLUE}------------------------------------------------------------${NC}

${PURPLE}4.${NC} What is MariaDB root password ?

execute command ${RED}cat /etc/codexpanel/mysqlPassword${NC} will show you the root password
...
${RED}/etc/codexpanel/mysqlPassword${NC}

${RED}/usr/local/CodexCP/CodexCP/settings.py${NC}

otherwise CodexPanel will not have access to database.

${BLUE}------------------------------------------------------------${NC}

${PURPLE}6.${NC} How to raise upload limit for codexpanel's phpMyAdmin and File Manager?
...
For OpenLiteSpeed, please check this post: ${GREEN}https://community.codexpanel.net/c/support/55${NC}

For LiteSpeed Enterprise, please check this post: ${GREEN}https://community.codexpanel.net/c/support/55${NC}

${BLUE}------------------------------------------------------------${NC}

${PURPLE}8.${NC} How to remove 8090 port in CodexPanel URL ?

Please check this post ${GREEN}https://blog.codexpanel.net/2018/12/25/how-to-remove-port-8090-from-codexpanel/${NC}
