...
app.controller('listWebsites', function ($scope, $http, $window) {
    ...
    $scope.CodexPanelLoading = true;

    $scope.issueSSL = function (virtualHost) {
        $scope.CodexPanelLoading = false;
...
app.controller('websitePages', function ($scope, $http, $timeout, $window) {
    ...
    const httpToHTTPS = `### Rewrite Rules Added by CodexPanel Rewrite Rule Generator

RewriteEngine On
RewriteCond %{HTTPS}  !=on
RewriteRule ^/?(.*) https://%{SERVER_NAME}/$1 [R,L]

### End CodexPanel Generated Rules.

`;

    const WWWToNonWWW = `### Rewrite Rules Added by CodexPanel Rewrite Rule Generator
...
`;
    ...
    const nonWWWToWWW = `### Rewrite Rules Added by CodexPanel Rewrite Rule Generator
...
`;
    ...
    const WordpressProtect = `### Rewrite Rules Added by CodexPanel Rewrite Rule Generator
