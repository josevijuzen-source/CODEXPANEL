...
def test_firewall_blocking():
    ...
    # Test configuration
    base_url = "https://localhost:8090"  # Adjust based on your CodexPanel setup
    ...
    print("1. Valid CodexPanel session with admin privileges")
    print("2. CodexPanel addons enabled")
    print("3. Active firewalld service")
    print()
    
    print("To test manually:")
    print("1. Login to CodexPanel dashboard")
