    ...
    def submitPackage(self):
        try:
            ...
            if not has_addons and enforceDiskLimits == 1:
                data_ret = {'saveStatus': 0, 'error_message': "Resource limits feature requires CodexPanel addons. Please visit https://codexpanel.net/codexpanel-addons to purchase."}
                json_data = json.dumps(data_ret)
                return HttpResponse(json_data)
